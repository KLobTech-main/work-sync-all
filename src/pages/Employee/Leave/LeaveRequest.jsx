...
function LeaveRequest() {
  ...
  useEffect(() => {
    if (email && token) {
      axios
        .get(
          `https://work-management-cvdpavakcsa5brfb.canadacentral-01.azurewebsites.net/api/leaves/${email}`,
          {
  ...
  const handleSubmitLeave = () => {
    ...
    if (email && token) {
      axios
        .post(
          "https://work-management-cvdpavakcsa5brfb.canadacentral-01.azurewebsites.net/api/leaves",
          {
            email,
            reason,
            leaveType,
